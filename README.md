...
저는 크리에이티브 스튜디오 [**레벨나인(Rebel9)**](https://rebel9.co.kr)에서 여러가지 인터랙티브 프로젝트들을 개발해왔습니다. 레벨나인은 여러 지역단체나 기관의 홍보와 관련된 의뢰를 받아 크리에이티브한 비주얼이나 인터랙션으로 사람들의 눈을 모으는 작업을 하는 회사였습니다. AR 컨텐츠는 현장성을 가지면서도 3D 모델을 통해 새로운 경험을 제시할 수 있는 좋은 수단이 되었고, 광주광역시의 대동을 시작으로 제주도 용담동, 성북구의 정릉, 여의도 선유도공원 등을 배경으로 한 프로젝트들을 제작하게 되었습니다.
