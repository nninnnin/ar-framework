...
각 프로젝트는 모바일 웹 애플리케이션에서 제공되는 지도와 체험장소를 확인하고 지역을 돌아다니며 5~6개의 AR 컨텐츠를 체험할 수 있도록 기획 및 제작되었습니다. 예를 들어 제주도 용담동의 지역개발을 목표로 개발된 프로젝트 <용담플레이>는 7마리의 용들을 찾는다는 컨셉트로, 모바일 웹 애플리케이션을 통해 지도로 여러 위치를 탐색하여 각 장소에 걸맞게 설계된 AR 컨텐츠를 확인하고 캡쳐기능을 통해 사진을 촬영하고 보상을 모으는 형태로 제작되었습니다.
